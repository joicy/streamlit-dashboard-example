...
#Make sure you replace ... with your own folder directory where the files are saved
housing_price_df = pd.read_csv('./state_market_tracker.tsv000.gz', compression='gzip', sep='\t', quotechar='"')
...
housing_price_df=housing_price_df[(housing_price_df['period_begin']>='2020-10-01') & (housing_price_df['period_begin']<='2021-09-01')]
